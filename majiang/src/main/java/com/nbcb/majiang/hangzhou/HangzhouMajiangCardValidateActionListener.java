...
public class HangzhouMajiangCardValidateActionListener implements
		ActionListener {
	...
	public void listen(Game game, Action action) {
		...
		HangzhouMajiangGameInfo gameInfo = (HangzhouMajiangGameInfo) game
				.getGameInfo();
